...
class TestSingleNucleotideVariant(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.sv1 = ca.SingleNucleotideVariant(chrom="1", pos=1000, ref_allele="A",
                                              alt_allele="G", ref_count=10, alt_count=10)
        self.sv2 = ca.SingleNucleotideVariant(chrom="1", pos=1000, ref_allele="A",
                                              alt_allele="C", ref_count=10, alt_count=10)
        self.sv3 = ca.SingleNucleotideVariant(chrom="1", pos=1001, ref_allele="T",
                                              alt_allele="G", ref_count=10, alt_count=10)
        self.sv4 = ca.SingleNucleotideVariant(chrom="2", pos=1000, ref_allele="A",
                                              alt_allele="G", ref_count=10, alt_count=10)
