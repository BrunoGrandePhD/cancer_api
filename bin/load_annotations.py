...
def main():
    ...
    for row_dict in data_gen(gene_data, GENE_FIELDNAMES):
        ...
        gene_dict = {
            'ensembl_id': row_dict['ensembl_gene_id'],
            'gene_symbol': row_dict['hgnc_symbol'],
            'biotype': row_dict['gene_biotype'],
            'gene_name': row_dict['external_gene_name'],
            'chromosome': row_dict['chromosome_name'],
            'start_position': row_dict['start_position'],
            'end_position': row_dict['end_position']
        }
        db_cnx.addGene(**gene_dict)
        gene_counter += 1
    ...
    for row_dict in data_gen(exon_data, EXON_FIELDNAMES):
        ...
        transcripts[row_dict['ensembl_transcript_id']].update({
            ...
            'ensembl_gene_id': row_dict['ensembl_gene_id']
        })
        ...
        transcripts[row_dict['ensembl_transcript_id']]['exons'].append({
            'ensembl_exon_id': row_dict['ensembl_exon_id'],
            ...
            'genome_start': row_dict['exon_chrom_start'],
            'genome_end': row_dict['exon_chrom_end'],
    ...
    for transcript_dict in transcripts.values():
        ...
        transcript_id = db_cnx.addTranscript(**transcript_dict)
